...
const leaderboardData = [
  ...
  { rank: 4, name: 'User 4', score: 850 },
  { rank: 5, name: 'User 5', score: 800 },
];
...
<template>
    ...
    >
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-8">
                <table class="min-w-full bg-white dark:bg-gray-800/50 rounded-lg overflow-hidden">
                    ...
                    <tbody>
                        <tr class="text-gray-200" v-for="user in leaderboardData" :key="user.rank">
